		...
		<tbody>
			<c:forEach items="${actingRoles}" var="actingRole">
				<tr>
					...
					<td><a href="${actingRole.getDetailLink()}"
						class="block width-100p text-overflow-el">${actingRole.forPrintTitle}</a>
					</td>
					<td class="visible-on-sm-down"><a
						href="${actingRole.getDetailLink()}"
						class="flex flex-row-wrap flex-ai-c"> <span
							class="badge badge-primary bold margin-right-10">${actingRole.id}</span>
